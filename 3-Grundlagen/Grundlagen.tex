...
Allgemein spricht man bei funktionalen Programmensprachen von \textit{first-class functions} und \textit{higher-order functions}~\cite[S.~50]{butcher_seven_2014}~\cite[S.~3~\&~S.~19]{chiusano_functional_2015}.\\
